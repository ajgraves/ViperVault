...
- `bottom`: This is a boolean (true/false) that indicates if the newest output is at the bottom (`true`) or top (`false`, default). The output will automatically scroll to the top or bottom, depending on how this option is set.
